...
import com.veer.filepicker.adapter.ImagePickAdapter;
...
public class ImagePickActivity extends FilePickerActivity {
    ...
    private void initView() {
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(FilePickerConstant.RESULT_PICK_IMAGE, mSelectedList);
