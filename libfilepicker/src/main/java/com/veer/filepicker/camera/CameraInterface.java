...
import com.veer.filepicker.camera.util.AngleUtil;
import com.veer.filepicker.camera.util.CameraParamUtil;
import com.veer.filepicker.camera.util.CheckPermission;
import com.veer.filepicker.camera.util.DeviceUtil;
...
//        }
        ...
        videoFileName = "camera_" + System.currentTimeMillis() + ".mp4";
        if (saveVideoPath.equals("")) {
            saveVideoPath = Utils.getApp().getExternalMediaDirs()[0].getPath();
        }
