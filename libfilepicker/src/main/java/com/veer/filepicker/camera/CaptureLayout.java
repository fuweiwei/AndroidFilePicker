...
import com.veer.filepicker.camera.listener.CaptureListener;
import com.veer.filepicker.camera.listener.ClickListener;
import com.veer.filepicker.camera.listener.ReturnListener;
import com.veer.filepicker.camera.listener.TypeListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    public  View view_confirm;            //底部确认布局
    ...
    public void initEvent() {
        ...
        view_confirm.setVisibility(GONE);
    }
    ...
    public void startTypeBtnAnimator() {
        ...
        view_confirm.setVisibility(VISIBLE);
    ...
    private void initView() {
        ...
        //拍照按钮
        btn_capture = new CaptureButton(getContext(), ConvertUtils.dp2px(84), ConvertUtils.dp2px(64));
...
//                resetCaptureLayout();
        ...
        txt_tip.setTextSize(12f);
        txt_tip.setTextColor(0xFFFFFFFF);
        txt_tip.setGravity(Gravity.CENTER);
        txt_tip.setLayoutParams(txt_param);

        //view_confirm
        view_confirm = LayoutInflater.from(getContext()).inflate(R.layout.vw_bottom_send,this,false);
        LayoutParams confirm_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        confirm_param.setMargins(0,0,0,-ConvertUtils.px2dp(10));
        Button btnConfirm =  view_confirm.findViewById(R.id.btn_confirm);
        confirm_param.gravity = Gravity.CENTER;
        view_confirm.setLayoutParams(confirm_param);
...
//        this.addView(view_confirm);
     ...
     * @param btnString
     */
    public void setBottomConfirmText(String textString,String btnString){
        this.textString = textString;
        this.btnString = btnString;
        if(view_confirm==null) return;
        TextView textView = view_confirm.findViewById(R.id.tv_content);
        if(!TextUtils.isEmpty(textString))textView.setText(textString);
        Button btnConfirm =  view_confirm.findViewById(R.id.btn_confirm);
        if(!TextUtils.isEmpty(textString)) btnConfirm.setText(btnString);
    }
