...
import com.veer.filepicker.camera.util.CheckPermission;
import com.veer.filepicker.camera.util.LogUtil;

import static com.veer.filepicker.camera.ZCameraView.BUTTON_STATE_BOTH;
import static com.veer.filepicker.camera.ZCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.veer.filepicker.camera.ZCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFFFFFFFF;            //进度条颜色
    ...
    public CaptureButton(Context context, int size,int insideSize) {
        super(context);
        this.button_size = size;
        button_radius = size / 2.0f;

        button_outside_radius = button_radius;
        button_inside_radius = insideSize / 2.0f;

        strokeWidth = ConvertUtils.dp2px(3);
        outside_add_size = ConvertUtils.dp2px(12);
        inside_reduce_size =ConvertUtils.dp2px(15);
